...
public class Main{
    ...
    private ArrayList<Attribute> getAttributesForFeatureset(ArrayList<Feature> features){
...
//        if(features.contains(featureSet.NUMBER_OF_BARS)) attributes.add(new Attribute("NUM_BARS"));
    ...
    public double getAccuracy(AbstractClassifier classifier, ArrayList<Feature> features){
        ...
        try{
            writeArffFile(instances_name,instances);
...
//            return accuracy;
    ...
    public String features_names(ArrayList<Feature> features) {
        String out = "";
        for(Feature feature: features){
            out += feature.getName();
            out += "_";
